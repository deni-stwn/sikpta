@extends('layouts.app')
@section('content')
    <x-navbar title="Arsip Surat"></x-navbar>
    <!-- Main content -->
                ...
                <tbody>
                    @foreach ($arsip as $item)
                        <tr>
                            ...
                            <td class="border-b border-gray-200 bg-white text-sm">{{ $item->surat->nomor_surat }}</td>
                            <td class="border-b border-gray-200 bg-white text-sm">{{ $item->surat->jenis_surat }}</td>
                            <td class="border-b border-gray-200 bg-white text-sm">
                                <a target="_blank" class="btn btn-info" style="color: white !important; "
                                    href="{{ Storage::url($item->file) }}">
                                    <i class="fas fa-eye"></i> Lihat File
                                </a>
                            </td>
                            {{-- <td class="border-b border-gray-200 bg-white text-sm flex gap-4 ">
